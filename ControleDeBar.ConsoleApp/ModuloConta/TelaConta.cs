...
public class TelaConta : ITela
{
    ...
    public void ApresentarMenuGestaoPedidos()
    {
        ...
        Console.Write("Digite o ID da conta que deseja atualizar: ");
    ...
    private Conta ObterDados()
    {
        ...
        Garcom garcomSelecionado = repositorioGarcom.SelecionarRegistroPorId(idMesa);
    ...
    private void AdicionarPedido(Conta contaSelecionada)
    {
        while (true)
        {
            ...
            Produto produto = repositorioProduto.SelecionarRegistroPorId(idProduto);

            Pedido novoPedido = contaSelecionada.RegistrarPedido(produto, quantidadeSolicitada);

            ApresentarMensagem($"Pedido \"{novoPedido.ToString()}\" adicionado com sucesso!", ConsoleColor.Green);
